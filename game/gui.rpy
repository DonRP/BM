...
init python:
    ...
    style.hyperlink_text.color = '#FF4343'
################################################################################
...
define gui.text_font = "calibrili.ttf"

## The font used for character names.
define gui.name_text_font = "SCRIPTIN.ttf"
...
########## Title font & position
define gui.title_text_font = "SCRIPTIN.ttf"
define gui.title_text_outlines = [ (0, "#ffffff80", 2, 2) ]
define gui.title_yalign = 0.1

define gui.version_text_outlines = [ (0, "#ffffff80", 2, 2) ]
...
define gui.main_menu_background = "images/jpg/livingroom rachel couch1.jpg"
...
define gui.name_text_outlines = [ (4, "#222", 2, 2), (2, "#bbb", 0, 0) ]
...
init python:
    ...
    if renpy.variant("small"):
        ...
        gui.choice_button_text_idle_color = "#555555"
