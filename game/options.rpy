...
define config.name = _("Bad Memories")
...
define gui.about = _p("""{size=+50}{font=SCRIPTIN.ttf}Bad Memories{/font}{/size}
...
define build.name = "Bad-Memories"
define config.steam_appid = 1595030
...
define config.save_directory = "BM-1544724770"
...
define build.itch_project = "bm-rec/bad-memories"
