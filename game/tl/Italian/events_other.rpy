...
translate italian cafe_d6_426a1e87:
    ...
    "Donna" "Hey, [h], è [heshe] il motivo per cui stai lavorando al tuo giorno libero?"
...
translate italian cafe_d6_316345e8:
    ...
    "Donna" "No? Non sei appena tempesta in qui 10 minuti fa, e pregato Jason di prendere il suo turno?"
...
translate italian porngirls_5458163c:
    ...
    "{color=#cc5dcd}Girl2{/color}" "Vieni su [em], non perdere tempo con [himher]!"
...
translate italian d10hcall_feaf42ce:
...
translate italian d10hcall_b852bf3c:

    # pc "Haha, what's up Hanna, ready for the date later today?"
    pc "Haha, che cos'è Hanna, pronto per la data più tardi oggi?"
...
translate italian d10hdate_8af4cc2b:

    # pc "Why don't we sit down and wait until the rains stops?"
    pc "Perché non ci sediamo e aspettiamo che le piogge si fermino?"
...
translate italian d11visitcafe_3fc070f9:

    # pc "Oh that reminds me, the house where you and your parent live, do you know what was in there when I was still a kid?"
    pc "Oh che mi ricorda, la casa in cui vivete tu e il tuo genitore, sai cosa c'era lì quando ero ancora un bambino?"
...
translate italian d11maggylewd_441ec405:

    # pcthink "Damn, these curves!"
    pcthink "Dannazione, queste curve!"
...
translate italian d11maggylewd_11d4a6af:

    # ma "So, it looks like my boss will leave the office for a while..."
    ma "Quindi, sembra che il mio capo lascerà l'ufficio per un po'..."
...
translate italian d11malfm_8c2785ed:

    # ma "It would be quite embarrassing if my boss would come in on us now."
    ma "Sarebbe piuttosto imbarazzante se il mio capo entrasse su di noi ora."
